...
const en = {
  ...
  register: {
    ...
    race: {
      ...
      ageRequiresChild: 'Your age ({age}) requires the Child category (max {maxAge})',
      ageRequiresAdult: 'Your age ({age}) requires the Adult category',
      errors: {
        participantType: 'Please select a Participant Type',
        distance: 'Please select a Race Distance',
        ageRequiresChild: 'Based on your date of birth, please select Child instead',
        ageRequiresAdult: 'Based on your date of birth, please select Adult instead',
      },
...
const th: Dictionary = {
  ...
  register: {
    ...
    race: {
      ...
      ageRequiresChild: 'อายุของคุณ ({age} ปี) ต้องเลือกประเภท Child (ไม่เกิน {maxAge} ปี)',
      ageRequiresAdult: 'อายุของคุณ ({age} ปี) ต้องเลือกประเภท Adult',
      errors: {
        participantType: 'กรุณาเลือกประเภทผู้สมัคร',
        distance: 'กรุณาเลือกระยะการวิ่ง',
        ageRequiresChild: 'จากวันเดือนปีเกิดของคุณ กรุณาเลือก Child แทน',
        ageRequiresAdult: 'จากวันเดือนปีเกิดของคุณ กรุณาเลือก Adult แทน',
      },
